...
You need OMNeT++ (version 5.6.2, https://omnetpp.org/download/) for using this framework. Ensure that OMNeT++ works. Create a new workspace and import all folders which are within the 5G-SIM-V2IN folder. 
