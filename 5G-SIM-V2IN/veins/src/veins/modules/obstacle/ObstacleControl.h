...
public:
    ...
    //for 5G-SIM-V2I/N
    bool isNLOS(const Coord &senderPos, const Coord &receiverPos,
     ...
     */
    std::vector<std::pair<Obstacle*, std::vector<double>>> getIntersections(
            const Coord &senderPos, const Coord &receiverPos) const;
    bool checkNLOS3D(const Coord &senderPos, const Coord &receiverPos, const double hBuilding) const;
