...
void ScenarioManager::processSetChannelParamCommand(const cXMLElement *node)
{
    ...
    //EV << "Setting channel parameter: " << parAttr << " = " << valueAttr       << " on connection " << pair.first->getFullPath() << " --> " << pair.first->getNextGate()->getFullPath()       << (pair.second ? " and its reverse connection" : "") << "\n";
...
void ScenarioManager::processDisconnectCommand(const cXMLElement *node)
{
    ...
    //EV << "Disconnecting " << pair.first->getFullPath() << " --> " << pair.first->getNextGate()->getFullPath()       << (pair.second ? " and its reverse connection" : "") << "\n";
