...
{
    //EV << "** Signal at T=" << simTime()       << " to " << getSimulation()->getContextModule()->getFullPath() << ": "       << cComponent::getSignalName(signalID) << " "       << (obj ? obj->str() : "") << " "       << (details ? details->str() : "")       << "\n";
}

void printSignalBanner(simsignal_t signalID, intval_t value, const cObject *details)
{
    //EV << "** Signal at T=" << simTime()       << " to " << getSimulation()->getContextModule()->getFullPath() << ": "       << cComponent::getSignalName(signalID) << " "       << value << " "       << (details ? details->str() : "")       << "\n";
}
