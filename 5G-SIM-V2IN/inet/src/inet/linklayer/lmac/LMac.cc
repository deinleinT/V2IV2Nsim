...
void LMac::initialize(int stage)
{
    ...
    if (stage == INITSTAGE_LOCAL) {
        ...
        //EV_DETAIL << " slotDuration = " << slotDuration                  << " controlDuration = " << controlDuration                  << " numSlots = " << numSlots                  << " bitrate = " << bitrate << endl;
...
void LMac::handleUpperPacket(Packet *packet)
{
    ...
    //EV_DETAIL << "packet put in queue\n  queue size: " << txQueue->getNumPackets() << " macState: " << macState              << "; mySlot is " << mySlot << "; current slot is " << currSlot << endl;
}
