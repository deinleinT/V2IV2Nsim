...
void Ieee802154Mac::initialize(int stage)
{
    ...
    if (stage == INITSTAGE_LOCAL) {
        ...
        //EV_DETAIL << " bitrate = " << bitrate                  << " backoff method = " << par("backoffMethod").stringValue() << endl;
...
void Ieee802154Mac::handleLowerPacket(Packet *packet)
{
    ...
    //EV_DETAIL << "Received frame name= " << csmaHeader->getName()              << ", myState=" << macState << " src=" << src              << " dst=" << dest << " myAddr="              << address << endl;
