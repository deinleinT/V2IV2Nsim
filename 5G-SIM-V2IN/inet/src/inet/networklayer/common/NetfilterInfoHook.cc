...
{
    //EV_INFO << "HOOK " << getFullPath() << ": PREROUTING packet=" << check_and_cast<cObject *>(datagram)->getName()            << " inIE=" << (inIE ? inIE->getName() : "nullptr")            << endl;
...
{
    //EV_INFO << "HOOK " << getFullPath() << ": FORWARD: packet=" << check_and_cast<cObject *>(datagram)->getName()            << " inIE=" << (inIE ? inIE->getName() : "nullptr")            << " outIE=" << (outIE ? outIE->getName() : "nullptr")            << " nextHop=" << nextHopAddr            << endl;
    return INetfilter::IHook::ACCEPT;
}
...
{
    //EV_INFO << "HOOK " << getFullPath() << ": POSTROUTING packet=" << check_and_cast<cObject *>(datagram)->getName()            << " inIE=" << (inIE ? inIE->getName() : "nullptr")            << " outIE=" << (outIE ? outIE->getName() : "nullptr")            << " nextHop=" << nextHopAddr            << endl;
    return INetfilter::IHook::ACCEPT;
}

INetfilter::IHook::Result NetfilterInfoHook::datagramLocalInHook(INetworkDatagram *datagram, const InterfaceEntry *inIE)
{
    //EV_INFO << "HOOK " << getFullPath() << ": LOCAL IN: packet=" << check_and_cast<cObject *>(datagram)->getName()            << " inIE=" << (inIE ? inIE->getName() : "nullptr")            << endl;
    return INetfilter::IHook::ACCEPT;
}
...
{
    //EV_INFO << "HOOK " << getFullPath() << ": LOCAL OUT: packet=" << check_and_cast<cObject *>(datagram)->getName()            << " outIE=" << (outIE ? outIE->getName() : "nullptr")            << endl;
    return INetfilter::IHook::ACCEPT;
}
