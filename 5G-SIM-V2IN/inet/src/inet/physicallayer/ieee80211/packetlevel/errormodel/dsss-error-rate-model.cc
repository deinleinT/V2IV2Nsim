...
double DsssErrorRateModel::GetDsssDqpskCck5_5SuccessRate(double sinr, uint32_t nbits)
{
#ifdef ENABLE_GSL
...
double DsssErrorRateModel::GetDsssDqpskCck11SuccessRate(double sinr, uint32_t nbits)
{
#ifdef ENABLE_GSL
    // symbol error probability
...
double DsssErrorRateModel::SymbolErrorProb16Cck(double e2)
{
    double sep;
    double error;
