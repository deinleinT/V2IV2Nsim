...
void BgpSession::sendOpenMessage()
{
    ...
    //EV_INFO << "Sending BGP Open message to " << _info.peerAddr.str(false) <<            " on interface " << _info.linkIntf->getInterfaceName() <<            "[" << _info.linkIntf->getInterfaceId() << "] with contents:\n";
...
void BgpSession::sendUpdateMessage(std::vector<BgpUpdatePathAttributes*> &content, BgpUpdateNlri &NLRI)
{
    ...
    //EV_INFO << "Sending BGP Update message to " << _info.peerAddr.str(false) <<            " on interface " << _info.linkIntf->getInterfaceName() <<            "[" << _info.linkIntf->getInterfaceId() << "] with contents:\n";
...
void BgpSession::sendKeepAliveMessage()
{
    ...
    //EV_INFO << "Sending BGP Keep-alive message to " << _info.peerAddr.str(false) <<            " on interface " << _info.linkIntf->getInterfaceName() <<            "[" << _info.linkIntf->getInterfaceId() << "] \n";
