...
protected:
  ...
  public:
    ...
    {
        Enter_Method_Silent("getX2NodeId");
    ...
    {
        Enter_Method_Silent("setMacNodeId");
    ...
    {
        Enter_Method_Silent("getIPAddressByMacNodeId");
    ...
    {
        Enter_Method_Silent("setX2NodeId");
    ...
    {
        Enter_Method_Silent("getX2PeerAddress");
    ...
    {
        Enter_Method_Silent("setX2PeerAddress");
    ...
    int getNodeCount() {
        Enter_Method_Silent("getNodeCount");
    ...
    {
        Enter_Method_Silent("addExtCell");
    ...
    {
        Enter_Method_Silent("getExtCellList");
    ...
    {
        Enter_Method_Silent("addEnbInfo");
    ...
    {
        Enter_Method_Silent("getEnbList");
