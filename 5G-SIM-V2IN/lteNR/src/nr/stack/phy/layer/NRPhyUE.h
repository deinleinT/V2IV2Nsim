...
protected:
    ...
    virtual void finish();
    virtual void triggerHandover() override;
    virtual void doHandover() override;
    virtual void handoverHandler(LteAirFrame* frame, UserControlInfo* lteInfo) override;
