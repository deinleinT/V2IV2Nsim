...
{
    //std::cout << "LteHandoverManager::handleMessage start at " << simTime().dbl() << std::endl;
    ...
    if (incoming == x2Manager_[IN])
    {
        ...
        delete msg;
    //std::cout << "LteHandoverManager::handleMessage end at " << simTime().dbl() << std::endl;
}

void LteHandoverManager::handleX2Message(cPacket* pkt)
{
    //std::cout << "LteHandoverManager::handleX2Message start at " << simTime().dbl() << std::endl;
    ...
    //std::cout << "LteHandoverManager::handleX2Message end at " << simTime().dbl() << std::endl;
}

void LteHandoverManager::sendHandoverCommand(MacNodeId ueId, MacNodeId enb, bool startHo)
{
    //std::cout << "LteHandoverManager::sendHandoverCommand start at " << simTime().dbl() << std::endl;

    Enter_Method_Silent("sendHandoverCommand");
    ...
    //std::cout << "LteHandoverManager::sendHandoverCommand end at " << simTime().dbl() << std::endl;
}

void LteHandoverManager::receiveHandoverCommand(MacNodeId ueId, MacNodeId enb, bool startHo)
{
    //std::cout << "LteHandoverManager::receiveHandoverCommand start at " << simTime().dbl() << std::endl;

    Enter_Method_Silent("receiveHandoverCommand");
    ...
    //std::cout << "LteHandoverManager::receiveHandoverCommand end at " << simTime().dbl() << std::endl;
}


void LteHandoverManager::forwardDataToTargetEnb(IPv4Datagram* datagram, MacNodeId targetEnb)
{
    //std::cout << "LteHandoverManager::forwardDataToTargetEnb start at " << simTime().dbl() << std::endl;

    Enter_Method_Silent("forwardDataToTargetEnb");
    ...
    //std::cout << "LteHandoverManager::forwardDataToTargetEnb end at " << simTime().dbl() << std::endl;
}

void LteHandoverManager::receiveDataFromSourceEnb(IPv4Datagram* datagram, MacNodeId sourceEnb)
{
    //std::cout << "LteHandoverManager::receiveDataFromSourceEnb start at " << simTime().dbl() << std::endl;

    Enter_Method_Silent("receiveDataFromSourceEnb");
    ...
    //std::cout << "LteHandoverManager::receiveDataFromSourceEnb end at " << simTime().dbl() << std::endl;
}
