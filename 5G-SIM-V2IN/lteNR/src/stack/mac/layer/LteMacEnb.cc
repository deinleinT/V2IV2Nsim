...
{
    //std::cout << "LteMacEnb::getCellInfo start at " << simTime().dbl() << std::endl;

    Enter_Method_Silent("getCellInfo");
    ...
    //std::cout << "LteMacEnb::getCellInfo end at " << simTime().dbl() << std::endl;
}

int LteMacEnb::getNumAntennas()
{
    //std::cout << "LteMacEnb::getNumAntennas  at " << simTime().dbl() << std::endl;

    Enter_Method_Silent("getNumAntennas");
...
{
    //std::cout << "LteMacEnb::getSchedDiscipline start at " << simTime().dbl() << std::endl;

    Enter_Method_Silent("getSchedDiscipline");
    ...
    //std::cout << "LteMacEnb::getSchedDiscipline end at " << simTime().dbl() << std::endl;
}

double LteMacEnb::getLteAdeadline(LteTrafficClass tClass, Direction dir)
{
    //std::cout << "LteMacEnb::getLteAdeadline start at " << simTime().dbl() << std::endl;

    Enter_Method_Silent("getLteAdeadline");
    ...
    //std::cout << "LteMacEnb::getLteAdeadline end at " << simTime().dbl() << std::endl;
}

double LteMacEnb::getLteAslackTerm(LteTrafficClass tClass, Direction dir)
{
    //std::cout << "LteMacEnb::getLteAslackTerm start at " << simTime().dbl() << std::endl;

    Enter_Method_Silent("getLteAslackTerm");

    std::string a("lteAslackTerm");
    a.append(lteTrafficClassToA(tClass));
    a.append(dirToA(dir));

    //std::cout << "LteMacEnb::getLteAslackTerm end at " << simTime().dbl() << std::endl;
...
{
    //std::cout << "LteMacEnb::getLteAmaxUrgentBurst start at " << simTime().dbl() << std::endl;

    Enter_Method_Silent("getLteAmaxUrgentBurst");

    std::string a("lteAmaxUrgentBurst");
    a.append(lteTrafficClassToA(tClass));
    a.append(dirToA(dir));

    //std::cout << "LteMacEnb::getLteAmaxUrgentBurst end at " << simTime().dbl() << std::endl;

    return par(a.c_str());
}
int LteMacEnb::getLteAmaxFairnessBurst(LteTrafficClass tClass, Direction dir)
{
    //std::cout << "LteMacEnb::getLteAmaxFairnessBurst start at " << simTime().dbl() << std::endl;

    Enter_Method_Silent("getLteAmaxFairnessBurst");

    std::string a("lteAmaxFairnessBurst");
    a.append(lteTrafficClassToA(tClass));
    a.append(dirToA(dir));

    //std::cout << "LteMacEnb::getLteAmaxFairnessBurst end at " << simTime().dbl() << std::endl;
...
{
    //std::cout << "LteMacEnb::getLteAhistorySize start at " << simTime().dbl() << std::endl;

    Enter_Method_Silent("getLteAhistorySize");

    std::string a("lteAhistorySize");
    a.append(dirToA(dir));

    //std::cout << "LteMacEnb::getLteAhistorySize end at " << simTime().dbl() << std::endl;
...
{
    //std::cout << "LteMacEnb::getLteAgainHistoryTh start at " << simTime().dbl() << std::endl;

    Enter_Method_Silent("getLteAgainHistoryTh");

    std::string a("lteAgainHistoryTh");
    a.append(lteTrafficClassToA(tClass));
    a.append(dirToA(dir));

    //std::cout << "LteMacEnb::getLteAgainHistoryTh end at " << simTime().dbl() << std::endl;
...
{
    //std::cout << "LteMacEnb::getZeroLevel start at " << simTime().dbl() << std::endl;

    Enter_Method_Silent("getZeroLevel");

    std::string a("zeroLevel");
    a.append(SubFrameTypeToA(type));
    a.append(dirToA(dir));

    //std::cout << "LteMacEnb::getZeroLevel end at " << simTime().dbl() << std::endl;
...
{
    //std::cout << "LteMacEnb::getIdleLevel start at " << simTime().dbl() << std::endl;

    Enter_Method_Silent("getIdleLevel");

    std::string a("idleLevel");
    a.append(SubFrameTypeToA(type));
    a.append(dirToA(dir));

    //std::cout << "LteMacEnb::getIdleLevel end at " << simTime().dbl() << std::endl;
...
double LteMacEnb::getPowerUnit(Direction dir, LteSubFrameType type)
{
    ...
    Enter_Method_Silent("getPowerUnit");
...
double LteMacEnb::getMaxPower(Direction dir, LteSubFrameType type)
{
    ...
    Enter_Method_Silent("getMaxPower");
...
unsigned int LteMacEnb::getAllocationRbs(Direction dir)
{
    ...
    //std::cout << "LteMacEnb::getAllocationRbs start at " << simTime().dbl() << std::endl;

    Enter_Method_Silent("getAllocationRbs");
    ...
    //std::cout << "LteMacEnb::getAllocationRbs end at " << simTime().dbl() << std::endl;
}

bool LteMacEnb::getPfTmsAwareFlag(Direction dir)
{

    //std::cout << "LteMacEnb::getPfTmsAwareFlag start at " << simTime().dbl() << std::endl;

    Enter_Method_Silent("getPfTmsAwareFlag");
    ...
    //std::cout << "LteMacEnb::getPfTmsAwareFlag end at " << simTime().dbl() << std::endl;
}

void LteMacEnb::deleteQueues(MacNodeId nodeId)
{
    //std::cout << "LteMacEnb::deleteQueues start at " << simTime().dbl() << std::endl;
    ...
    //enbSchedulerDl_->updateHarqDescs(); //TODO
    ...
    //std::cout << "LteMacEnb::deleteQueues end at " << simTime().dbl() << std::endl;
}

/**
 * For soft handover, can be set in omnetpp.ini
 * exchanges the buffers on handover
 * not tested so far TODO
 * @param nodeId
 * @param newMasterMac
 * @param nodeQosInfos
 * @param oldMasterId
 * @param newMasterId
 */
void LteMacEnb::exchangeQueues(MacNodeId nodeId, LteMacEnb * newMasterMac, std::vector<QosInfo> nodeQosInfos, MacNodeId oldMasterId, MacNodeId newMasterId) {
    Enter_Method_Silent("exchangeQueues");
...
/////////////////////////////////mbuf//////////////////////////////////////////
    if (mbuf_.size() > 0) {
        ...
        for (auto & var : nodeQosInfos) {
            LteMacQueue * macQueue= nullptr; /*= new LteMacQueue(queueSize_)*/;
            for (mit = mbuf_.begin(); mit != mbuf_.end();) {
                if (var.cid == mit->first) {
                    if(mit->second != nullptr)
                        macQueue = mit->second->dup();
...
//            if(macQueue != nullptr)
//                newMasterMac->getMbuf()[var.cid] = macQueue;
        }
    }

/////////////////////////////macBuffer////////////////////////////////////////////
    if (macBuffers_.size() > 0) {
        LteMacBufferMap::iterator vit; // --> all buffers from oldMaster, make a dup and
        for (auto & var : nodeQosInfos) {
            for (vit = macBuffers_.begin(); vit != macBuffers_.end();) {
                if (var.cid == vit->first) {
                    if (vit->second != nullptr)
                        newMasterMac->getMacBuffers()->insert(
                                std::pair<MacCid, LteMacBuffer*>(var.cid,
                                        vit->second->dup()));       // TODO TEST
...
//////////////////////////////////////BSR///////////////////////////////////////
    LteMacBufferMap::iterator bit;
    LteMacBufferMap * tmpBsr = newMasterMac->getBsrVirtualBuffers();
    for (bit = bsrbuf_.begin(); bit != bsrbuf_.end();) {
        if (MacCidToNodeId(bit->first) == nodeId) {
            tmpBsr->insert(std::make_pair(bit->first,bit->second->dup())); //copy Buffer
            delete bit->second; // Delete Buffer
            bsrbuf_.erase(bit++); // Delete Elem
        } else {
            ++bit;
        }
...
///////////////////////////////////////////////////////////////////////////////////////
    ...
    for (auto & var : lcgMap_) {
        if (MacCidToNodeId(var.second.first) == nodeId) {
            newMasterMac->getLcgMap().insert(std::make_pair(var.first, var.second));
            lcgMap_.erase(var.first);
        }
    }

    for (auto & var : connDesc_) {
        if (var.second.getSourceId() == oldMasterId) {
            var.second.setSourceId(newMasterId);
            newMasterMac->getConnDesc().insert(var);
            connDesc_.erase(var.first);
        }
        if (var.second.getDestId() == oldMasterId) {
            var.second.setDestId(newMasterId);
            newMasterMac->getConnDesc().insert(var);
            connDesc_.erase(var.first);
        }
    }
    ...
    for (auto & var : connDescIn_) {
        if (var.second.getSourceId() == oldMasterId) {
            var.second.setSourceId(newMasterId);
            newMasterMac->getConnDescIn().insert(var);
            connDescIn_.erase(var.first);
        }
        if (var.second.getDestId() == oldMasterId) {
            var.second.setDestId(newMasterId);
            newMasterMac->getConnDescIn().insert(var);
...
//    enbSchedulerUl_->updateHarqDescs();
    ...
    // remove active connections from the schedulers
//    newMasterMac->getSchedulerEnbDl()->notifyActiveConnection(nodeId);
//    newMasterMac->getSchedulerEnbUl()->notifyActiveConnection(nodeId);
    enbSchedulerDl_->removeActiveConnections(nodeId);
    enbSchedulerUl_->removeActiveConnections(nodeId);

    // remove pending RAC requests
    newMasterMac->getSchedulerEnbUl()->signalRac(nodeId);
    enbSchedulerUl_->removePendingRac(nodeId); //TODO


}

/**
 * for handover, see method above
 * @param nodeId
 * @param nodeQosInfos
 * @param newMasterMac
 * @param oldMasterId
 * @param newMasterId
 */
void LteMacEnb::exchangeQosInfosFromQosHandler(MacNodeId nodeId, std::vector<QosInfo> nodeQosInfos,
        LteMacEnb * newMasterMac, MacNodeId oldMasterId, MacNodeId newMasterId) {

    for(auto & var : nodeQosInfos){
        if (nodeId == var.destNodeId || nodeId == var.senderNodeId) {
            MacCid cid = idToMacCid(nodeId, var.lcid);
            QosInfo tmp = var;
            if(oldMasterId == tmp.senderNodeId){
                tmp.senderNodeId = newMasterId;
...
{
    //std::cout << "LteMacEnb::handleMessage start at " << simTime().dbl() << std::endl;
    ...
    //std::cout << "LteMacEnb::handleMessage end at " << simTime().dbl() << std::endl;
}
...
void LteMacEnb::bufferizeBsr(MacBsr* bsr, MacCid cid) {
	//std::cout << "LteMacEnb::bufferizeBsr start at " << simTime().dbl() << std::endl;
	...
	if (it == bsrbuf_.end()) {
		if (bsr->getSize() > 0) {
			...
			//EV << "LteBsrBuffers : Added new BSR buffer for node: " << MacCidToNodeId(cid) << " for Lcid: " << MacCidToLcid(cid) << " Current BSR size: " << bsr->getSize() << "\n";
		...
		if (bsr->getSize() > 0) {
			...
			//EV << "LteBsrBuffers : Using old buffer for node: " << MacCidToNodeId(cid) << " for Lcid: " << MacCidToLcid(cid) << " Current BSR size: " << bsr->getSize() << "\n";

			// signal backlog to Uplink scheduler
			enbSchedulerUl_->backlog(cid);
			//EV << "LteBsrBuffers : Using old buffer for node: " << MacCidToNodeId(cid) << " for Lcid: " << MacCidToLcid(cid) << " - now empty" << "\n";
		}
	}
	//std::cout << "LteMacEnb::bufferizeBsr end at " << simTime().dbl() << std::endl;
}

void LteMacEnb::sendGrants(LteMacScheduleListWithSizes* scheduleList)
{
...
void LteMacEnb::macHandleRac(cPacket* pkt)
{
    ...
    unsigned int bytesize = uinfo->getBytesize();
...
void LteMacEnb::macPduMake(MacCid cid)
{
    ...
    //std::cout << "LteMacEnb::macPduMake start at " << simTime().dbl() << std::endl;
...
//        unsigned int sduPerCid = it->second;
    ...
    //std::cout << "LteMacEnb::macPduMake end at " << simTime().dbl() << std::endl;
}

void LteMacEnb::macPduUnmake(cPacket* pkt)
{
    //std::cout << "LteMacEnb::macPduUnmake start at " << simTime().dbl() << std::endl;
...
//        MacCid cid = idToMacCid(lteInfo->getSourceId(), 0);
    ...
    //std::cout << "LteMacEnb::macPduUnmake end at " << simTime().dbl() << std::endl;

}

int LteMacEnb::getNumRbDl()
{
    //std::cout << "LteMacEnb::getNumRbDl  at " << simTime().dbl() << std::endl;
...
{
    //std::cout << "LteMacEnb::getNumRbUl  at " << simTime().dbl() << std::endl;
...
{
    //std::cout << "LteMacEnb::bufferizePacket start at " << simTime().dbl() << std::endl;
...
//		EV << "LteMacBuffers : Using old buffer on node: " << MacCidToNodeId(cid) << " for Lcid: " << MacCidToLcid(cid) << ", Space left in the Queue: "<< queue->getQueueSize() - queue->getByteLength() << "\n";
    ...
    //std::cout << "LteMacEnb::bufferizePacket end at " << simTime().dbl() << std::endl;
...
{
    //std::cout << "LteMacEnb::handleUpperMessage start at " << simTime().dbl() << std::endl;
...
{
    //std::cout << "LteMacEnb::handleSelfMessage start at " << simTime().dbl() << std::endl;
...
//    EV << "============================================== UPLINK ==============================================" << endl;
    ...
    //std::cout << "LteMacEnb::handleSelfMessage end at " << simTime().dbl() << std::endl;
}
...
{
    //std::cout << "LteMacEnb::macHandleFeedbackPkt start at " << simTime().dbl() << std::endl;
...
//            i++;
    ...
    //std::cout << "LteMacEnb::macHandleFeedbackPkt end at " << simTime().dbl() << std::endl;
}

void LteMacEnb::updateUserTxParam(cPacket* pkt)
{
    //std::cout << "LteMacEnb::updateUserTxParam start at " << simTime().dbl() << std::endl;
    ...
    //std::cout << "LteMacEnb::updateUserTxParam end at " << simTime().dbl() << std::endl;
}
ActiveSet LteMacEnb::getActiveSet(Direction dir)
{
    //std::cout << "LteMacEnb::getActiveSet  at " << simTime().dbl() << std::endl;
...
{
    //std::cout << "LteMacEnb::allocatedRB  at " << simTime().dbl() << std::endl;

    Enter_Method_Silent("getCurrentSubFrameType");
...
{
    //std::cout << "LteMacEnb::getBandStatus  at " << simTime().dbl() << std::endl;
...
{
    //std::cout << "LteMacEnb::getPrevBandStatus  at " << simTime().dbl() << std::endl;
