...
std::vector<double> LteChannelModel::getSINR(LteAirFrame *frame, UserControlInfo* lteInfo, bool flag)
{
...
bool LteChannelModel::isCorrupted(LteAirFrame *frame, UserControlInfo* lteInfo)
{
   return true;
}
