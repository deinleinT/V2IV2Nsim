...
class LteFeedback
{
  ...
  public:
    ...
    {
        //std::cout << "LteFeedback::isEmptyFeedback at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::isPeriodicFeedback at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::hasRankIndicator at " << simTime().dbl() << std::endl;

        return (status_ & RANK_INDICATION);
    }
    bool hasWbCqi() const
    {
        //std::cout << "LteFeedback::hasWbCqi at " << simTime().dbl() << std::endl;

        return (status_ & WB_CQI);
    }
    bool hasWbPmi() const
    {
        //std::cout << "LteFeedback::hasWbPmi at " << simTime().dbl() << std::endl;

        return (status_ & WB_PMI);
    }
    bool hasBandCqi() const
    {
        //std::cout << "LteFeedback::hasBandCqi at " << simTime().dbl() << std::endl;

        return (status_ & BAND_CQI);
    }
    bool hasBandPmi() const
    {
        //std::cout << "LteFeedback::hasBandPmi at " << simTime().dbl() << std::endl;

        return (status_ & BAND_PMI);
    }
    bool hasPreferredCqi() const
    {
        //std::cout << "LteFeedback::hasPreferredCqi at " << simTime().dbl() << std::endl;

        return (status_ & PREFERRED_CQI);
    }
    bool hasPreferredPmi() const
    {
        //std::cout << "LteFeedback::hasPreferredPmi at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::getRankIndicator at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::getWbCqi at " << simTime().dbl() << std::endl;
    ...
    Pmi getWbPmi() const
    {
        //std::cout << "LteFeedback::getWbPmi at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::getBandCqi at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::getBandPmi at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::getPreferredCqi at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::getPreferredPmi at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::getPreferredBands at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::getTxMode at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::getAntennaId at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::setRankIndicator at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::setWideBandCqi at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::setWideBandPmi at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::setPerBandCqi at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::setPerBandPmi at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::setPreferredCqi at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::setPreferredPmi at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::setPreferredBands at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::setTxMode at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::setAntenna at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::setPeriodicity at " << simTime().dbl() << std::endl;
    ...
    {
        //std::cout << "LteFeedback::print at " << simTime().dbl() << std::endl;
