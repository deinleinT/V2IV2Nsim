...
void UmTxEntity::enque(cPacket* pkt)
{
    ...
    //std::cout << "UmTxEntity::enque start at " << simTime().dbl() << std::endl;
    ...
    //std::cout << "UmTxEntity::enque end at " << simTime().dbl() << std::endl;
}

void UmTxEntity::rlcPduMake(int pduLength)
{
    //std::cout << "UmTxEntity::rlcPduMake start at " << simTime().dbl() << std::endl;

    Enter_Method_Silent("rlcPduMake");
    ...
    //std::cout << "UmTxEntity::rlcPduMake end at " << simTime().dbl() << std::endl;
}

void UmTxEntity::removeDataFromQueue()
{
    //std::cout << "UmTxEntity::removeDataFromQueue start at " << simTime().dbl() << std::endl;

    Enter_Method_Silent("removeDataFromQueue");
    ...
    //std::cout << "UmTxEntity::removeDataFromQueue end at " << simTime().dbl() << std::endl;
}
...
{
    //std::cout << "UmTxEntity::rlcHandleD2DModeSwitch start at " << simTime().dbl() << std::endl;
...
//            }
    ...
    //std::cout << "UmTxEntity::rlcHandleD2DModeSwitch end at " << simTime().dbl() << std::endl;
}

std::pair<LteRlcUm*,LteRlcUmDataPdu*> UmTxEntity::rlcPduMake(int pduLength, bool flag)
{
    //std::cout << "UmTxEntity::rlcPduMake start at " << simTime().dbl() << std::endl;
    ...
    LteRlcUm* lteRlc = check_and_cast<LteRlcUm *>(getParentModule()->getSubmodule("um"));
    std::pair<LteRlcUm*,LteRlcUmDataPdu*> tmp(lteRlc,rlcPdu);
    //std::cout << "UmTxEntity::rlcPduMake end at " << simTime().dbl() << std::endl;
    return tmp;
}
