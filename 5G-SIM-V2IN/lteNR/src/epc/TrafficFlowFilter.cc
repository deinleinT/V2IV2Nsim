...
TrafficFlowTemplateId TrafficFlowFilter::findTrafficFlow(L3Address firstKey, TrafficFlowTemplate secondKey)
{
    ...
    //EV << "TrafficFlowFilter::findTrafficFlow - Cannot find entry for destAddress " << firstKey << " and values: [" << secondKey.addr << "," << secondKey.destPort << "," << secondKey.srcPort << "]" << endl;
...
{
    //EV << "TrafficFlowFilter::addTrafficFlow - checking existence of an entry for destAddress " << firstKey << " and values: [" << tft.addr << "," << tft.destPort << "," << tft.srcPort << "]" << endl;
    ...
    {
        //EV << "TrafficFlowFilter::addTrafficFlow - skipping duplicate entry  with destAddress " << firstKey << " and values: [" << tft.addr << "," << tft.destPort << "," << tft.srcPort << "]" << endl;
        return false;
    }
